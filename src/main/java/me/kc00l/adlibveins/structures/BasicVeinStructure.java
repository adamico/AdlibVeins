...
public class BasicVeinStructure extends Structure {
        ...
        public static final Codec<BasicVeinStructure> CODEC = RecordCodecBuilder
                        .<BasicVeinStructure>mapCodec(instance -> instance
                                        .group(BasicVeinStructure.settingsCodec(instance),
                                        ...
                                        .apply(instance, BasicVeinStructure::new))
                        .codec();
        ...
        protected BasicVeinStructure(Structure.StructureSettings config,
         ...
         * it to spawn in specific biomes that aren't in the dimension they don't like
         * if they wish.
         */
        private static boolean extraSpawningChecks(Structure.GenerationContext context) {
                ...
                int xBlockPos = chunkpos.getMinBlockX();
                int zBlockPos = chunkpos.getMinBlockZ();
                int radius = 1000;

                // spawns only when farther than 1000 blocks from world origin
        ...
        public Optional<Structure.GenerationStub> findGenerationPoint(Structure.GenerationContext context) {
                ...
                if (!BasicVeinStructure.extraSpawningChecks(context)) {
                ...
                Optional<Structure.GenerationStub> structurePiecesGenerator = JigsawPlacement.addPieces(
                                ...
                                this.startJigsawName, // Can be used to only spawn from one Jigsaw block. But we don't
                                                      // need to worry
                                // about this.
                                this.size, // How deep a branch of pieces can go away from center piece. (5 means
                                           // branches
                                ...
                                this.projectStartToHeightmap, // Adds the terrain height's y value to the passed in
                                                              // blockpos's y value.
                                ...
                                this.maxDistanceFromCenter); // Maximum limit for how far pieces can spawn from center.
                                                             // You cannot set
                                                             // this bigger than 128 or else pieces gets cutoff.

                /*
                 * Note, you are always free to make your own JigsawPlacement class and
                 * implementation of how the structure
                 * should generate. It is tricky but extremely powerful if you are doing
                 * something that vanilla's jigsaw system cannot do.
                 * Such as for example, forcing 3 pieces to always spawn every time, limiting
                 * how often a piece spawns, or remove the intersection limitation of pieces.
                 */
        ...
        public StructureType<?> type() {
                return AVStructures.VEIN_STRUCTURE.get(); // Helps the game know how to turn this structure back to json
                                                          // to save
                                                          // to chunks
        }
}
